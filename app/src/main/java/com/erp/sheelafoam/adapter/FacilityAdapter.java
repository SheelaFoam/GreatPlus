...
import com.erp.sheelafoam.BE.FacilityBE;
...
public class FacilityAdapter extends RecyclerView.Adapter<FacilityAdapter.EmployerJobsListedHolder> {

    Context context;
    ArrayList<FacilityBE> base;

    public FacilityAdapter(Context context, ArrayList<FacilityBE> base) {
