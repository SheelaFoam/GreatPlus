...
public class TaskAdapterSideMenu extends RecyclerView.Adapter<TaskAdapterSideMenu.EmployerJobsListedHolder> implements NetworkTask.Result {
    ...
    public TaskAdapterSideMenu(Context context, ArrayList<TaskBE> base) {
    ...
    public EmployerJobsListedHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.task_row_sidemenu, parent, false);
    ...
    public class EmployerJobsListedHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView task_matter, task_subject, task_name, task_divider, txt_approve, txt_disapprove, task_date;
    ...
    public void resultfromNetwork(String object, int id, int arg1, String arg2) {
        ...
        if (base.getInfo().get(0).getStatus() == 1) {
            ...
            ((HomeScreen) context).commonFragmentMethod(new MyTask(), null, null);
        } else {
