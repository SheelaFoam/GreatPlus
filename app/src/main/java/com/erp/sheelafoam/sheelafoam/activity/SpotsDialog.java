...
public class SpotsDialog extends AlertDialog {
    ...
    public static class Builder {
        ...
        public AlertDialog build() {
            return new SpotsDialog(
                    ...
                    themeId != 0 ? themeId : dmax.dialog.R.style.SpotsDialogDefault,
                    cancelable,
                    cancelListener
            );
        }
   ...
   public SpotsDialog(Context context, String message, int theme, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(dmax.dialog.R.layout.dmax_spots_dialog);
    ...
    private void initProgress() {
        dmax.dialog.ProgressLayout progress = (ProgressLayout) findViewById(R.id.dmax_spots_progress);
