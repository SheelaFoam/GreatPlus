...
public class ReportOrderStatusAdapter extends BaseAdapter {

	ArrayList<ProductListAddEditBean> _data;
	Context _c;
	TextView textview_purpose_name;
//	int flag;

	public ReportOrderStatusAdapter (ArrayList<ProductListAddEditBean> data, Context c){
		_data = data;
		_c = c;
	//	this.flag=flag;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ProductListAddEditBean entry=_data.get(position);
		...
		textview_purpose_name.setText(entry.getProductName());
